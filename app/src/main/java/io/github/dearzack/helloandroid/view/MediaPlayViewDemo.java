 ...
 */
public class MediaPlayViewDemo extends View {
    ...
    public MediaPlayViewDemo(Context context) {
        super(context);
    }

    public MediaPlayViewDemo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MediaPlayViewDemo(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        isInited = true;
        play_needle = ((BitmapDrawable) getResources().getDrawable(R.drawable.needle)).getBitmap();
        play_disc = ((BitmapDrawable) getResources().getDrawable(R.drawable.disc)).getBitmap();
...
//                    disc_x = getWidth() - 10 * needleScale;
            ...
            if (isPrev) {
                disc_x += 40;
                if (disc_x >= getWidth()) {
//                    disc_x = -(disc.getWidth()) + 10 * needleScale;
                    isPrev = false;
                    isPrevIn = true;
                    discRotracre = 0;
                }
